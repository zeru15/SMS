...
export const GET_ASSIGNED_SUBJECTS = 'GET_ASSIGNED_SUBJECTS'
export const DELETE_ASSIGNED_SUBJECT = 'DELETE_ASSIGNED_SUBJECT'
...
export const NEW_TEACHERS_LOADING = 'NEW_TEACHERS_LOADING'
export const EDIT_NEW_TEACHER = 'EDIT_NEW_TEACHER'
export const TEACHERS_LOADING = 'TEACHERS_LOADING'
export const ADD_TEACHER = 'ADD_TEACHER'
export const GET_TEACHERS = 'GET_TEACHERS'
export const GET_SELECTED_TEACHER = 'GET_SELECTED_TEACHER'
